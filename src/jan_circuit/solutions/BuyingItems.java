 ...
 * {https://github.com/AshokRajpurohit/karani/tree/master/src/com/ashok/}
 *
...
public class BuyingItems {
    ...
    private static long process(List<Seller> sellers, int items) {
        Process process = new Process(toArray(sellers), new boolean[items]);
        return process.minCost;
    }
